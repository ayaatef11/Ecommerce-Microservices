...
using Mango.Services.ShoppingCartApi.Services.Coupons;
using Mango.Services.ShoppingCartApi.Services.Products;
...
builder.Services.AddDbContext<CartContext>(option =>
{
